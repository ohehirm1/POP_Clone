...
<head>
    ...
    <title>{{ config('app.name', 'NDIS') }}</title>
    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                ...
                @else
                    <a href="{{ route('login') }}"
                        class="text-2xl text-gray-700 dark:text-gray-500 underline">Log
                        in</a>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <span
                    class="text-laravel text-6xl font-bold">{{ config('app.name', 'NDIS') }}</span>
            </div>
